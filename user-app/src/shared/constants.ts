...
export const PRIVACY_URL = 'https://lendlovellc.com/privacy';
export const TERMS_URL = 'https://lendlovellc.com/terms';
export const DELETE_ACCOUNT_URL = 'https://lendlovellc.com/delete-account';
export const SUPPORT_URL = 'https://lendlovellc.com/support';
